...
// 模糊搜索的魔法棒图标
export const MAGIC_WAND_SVG = `
<svg class="fuzzy-suggestion-icon" xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 -960 960 960" width="18px" fill="currentColor">
